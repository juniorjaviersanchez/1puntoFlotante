...
<body data-open="click" data-menu="vertical-menu" data-col="2-columns"
      ...
      <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
        <li class="nav-item">
          ...
          <ul class="menu-content">
            <li class="active">
              <a href="#" data-i18n="nav.dash.main" class="menu-item">Calcular IEEE754</a>
            </li>
            <li>
              <a href="sumaNumeros.php" data-i18n="nav.dash.main" class="menu-item">Calcular Suma</a>
            </li>
          </ul>
        </li>
      </ul>
  ...
  <div class="app-content content container-fluid">
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-xs-12 mb-1">
          <h2 class="content-header-title">CALCULAR IEEE754</h2>
        </div>
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Calcular IEEE754
              </li>
            </ol>
          </div>
        </div>
                        ...
                        <div class="card-block">
                          <div class="media">
                            <div class="media-body text-xs-left">
                              ...
                              <h2 class="teal">CALCULAR IEEE754 DE UN NÚMERO DECIMAL </h2>

                              <div class="form-group col-xl-7 col-lg-7">
                                <label for="userinput5">Número</label>
                                <input class="form-control border-primary" size="20" type="text"
                                  placeholder="Escribir Número" id="decimal" onkeyup="limpiarNumeroConPunto(this)"
                                  onchange="limpiarNumeroConPunto(this)">
                              </div>
                              <div class="form-group col-xl-7  col-lg-7">
                                <input id="solverBtn" class="btn btn-success" type="button" value="Conversión"
                                  onclick="valida();">
                              </div>
                        ...
                        <div class="card-block">
                          <div class="media">
                            <div class="media-body text-xs-left">
                              ...
                              <h2 class="teal" align="center">DESARROLLO </h2> <br>
                              ...
                              <div class="other-feature-item">
                                ...
                                <h2 class="teal">Paso N°0: Hallamos el signo .</h2>
                                <p>Si positivo Signo = 0 si no Signo = 1</p>
                                <a id="signo"></a>
                                <hr>

                                <h2 class="teal">Paso N°1: Pasamos a Binario</h2>
                                <p id="binario"></p>
                                <p>parte binaria </p>
                                <a id="binario_fraccion"></a>
                                <hr>

                                <h2 class="teal">Paso N°2: Hallamos exponente </h2>
                                <a id="exponente"></a>
                                <p>Sumamos 127 al exponente y lo pasamos a binario natural</p>
                                <a id="exponente_m"> </a>
                                <a>=></a>
                                <a id="exponente_binario"></a>
                                <hr>

                                <h2 class="teal">Paso N°3: Hallamos La Mantisa.</h2>
                                <p>Cogemos los 23 primeros decimales en binario
                                  Si faltan se rellenan con 0's por detras hasta llegar a 23
                                  De aqui tomamos los decimales del binario</p>
                                <a id="mantisa"></a>
                                <hr>

                                <h2 class="teal">Paso N°4: Unimos</h2>
                                <a id=""></a>
                                <hr>
                                <h2 class="teal">Resultado:</h2>
                                <p id="results">
                              </div>
    ...
    <footer class="footer footer-static footer-light navbar-border">
      <p class="clearfix text-muted text-sm-center mb-0 px-2">
        <span class="float-md-left d-xs-block d-md-inline-block">Copyright &copy; 2020
          <a href="#" target="_blank" class="text-bold-800 grey darken-2">PROJANET </a>. </span>
      </p>
    </footer>
    ...
    <script src="../../assets/personales/js/conversor.js"></script>´
